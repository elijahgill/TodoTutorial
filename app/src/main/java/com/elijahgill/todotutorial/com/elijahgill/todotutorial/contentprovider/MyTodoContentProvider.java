package com.elijahgill.todotutorial.com.elijahgill.todotutorial.contentprovider;
...
import com.elijahgill.todotutorial.database.TodoDatabaseHelper;
...
public class MyTodoContentProvider extends ContentProvider {
    ...
    // values for UriMatcher
    private static final int TODOS = 10;
    private static final int TODO_ID = 20;

    private static final String AUTHORITY = "com.elijahgill.todotutorial.contentprovider";
    ...
    private void checkColumns(String[] projection){
        String[] available = {TodoTable.COLUMN_CATEGORY, TodoTable.COLUMN_SUMMARY,
            TodoTable.COLUMN_DESCRIPTION, TodoTable.COLUMN_ID, TodoTable.COLUMN_IS_DONE,
            TodoTable.COLUMN_DUE_DATE, TodoTable.COLUMN_DATE_CREATED};
        if(projection!=null) {
            HashSet<String> requestedColumns = new HashSet<String>(Arrays.asList(projection));
            HashSet<String> availableColumns = new HashSet<String>(Arrays.asList(available));
            //check that all requested are available
